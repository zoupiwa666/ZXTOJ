...
<div style="max-width:600px">
  ...
  <div style="margin-bottom:10px">
    <label>消息内容</label>
    <textarea id="msgContent" rows="5" placeholder="输入系统消息内容（支持纯文本，最长2000字）" style="width:100%;padding:10px 12px;background:#1a1a1a;border:1px solid #333;border-radius:8px;color:#ddd;font-size:13px;outline:none;resize:vertical"></textarea>
  </div>
...
async function sendMsg(){
  ...
  try{
    const r=await fetch('api_send.php',{method:'POST',body:fd});
